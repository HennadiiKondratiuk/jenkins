        ...
        stage('Deploy') {
            steps {
                script{
                       ...
                       docker tag my-image:$BUILD_ID 319448237430.dkr.ecr.eu-central-1.amazonaws.com/hkondratiuk-images:${env.BUILD_ID}
                       docker push 319448237430.dkr.ecr.eu-central-1.amazonaws.com/hkondratiuk-images'''
